...
{
    $id=$_POST['id'];
    $s=$obj->getAboutImg($id);
    $c=mysqli_fetch_array($s);
    if(empty($_FILES['img']['name']))
    {
        $img=$c['img'];
        $u=$obj->updateAboutImg($id,$img);
        header("location:aboutImg.php?stat=1");
    }
    else
    {
...
<body>
    ...
    <div class="wrapper">
        ...
        ?>
            ...
            <div class="m-4">
                <h5 class="py-4">About Page Image Content </h5>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $a['id'];?></td>
                                    <td><img src="../assets/uploads/<?php echo $a['img'];?>" style="width: 80px;"></td>
