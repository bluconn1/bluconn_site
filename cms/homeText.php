...
if(isset($_POST['update']))
{
    ...
    $text3=$_POST['text3'];
    $text4=$_POST['text4'];
    $u=$obj->updateHomeText($id,$text1,$text2,$text3,$text4);
    header("location:homeText.php?stat=1");
}
...
<body>
    ...
    <div class="wrapper">
        ...
        ?>
            ...
            <div class="m-4">
                <h5 class="py-4">Home Page Text Content </h5>
